...
//        System.out.printf(result2);
            int [] a={162,192,216,218,231,239,244,251,286,288,289,291,292,301,303,305,306,307,308,311,316,319,320,321,322,328,336,338,339,346,351,352,359,369,373,376,378,382,383,388,393,394,402,403,416,900,146,155,159,236,298,310,313,349,353,368,377,380,384,391,392,398,401};
            Arrays.sort(a);
        for (int i : a) {
